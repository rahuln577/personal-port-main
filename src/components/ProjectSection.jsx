...

{
    ...
    return <div ref ={myref}className={`project ${isset?`scanim`:` `}`} id="project">
        <h1>Projects</h1>
        <div className="plist">
        <ProjectCard image={moviedb} title="MovieDB website" description="This is a website which has description of all the latest movies, basically a database for movies." github="https://github.com/rahuln577/moviedbfinal" live="https://moviesdbbyrahul.netlify.app"/>
